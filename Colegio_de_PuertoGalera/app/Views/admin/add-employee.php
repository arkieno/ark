	...
	<!-- <div class="main-wrapper">
		<div class="header">
			<div class="header-left">
				<a href="index.html" class="logo"> <img src="assets1/img/hotel_logo.png" width="50" height="70" alt="logo"> <span class="logoclass">Admin</span> </a>
				<a href="index.html" class="logo logo-small"> <img src="assets1/img/hotel_logo.png" alt="Logo" width="30" height="30"> </a>
			</div>
			...
			<ul class="nav user-menu">
						...
						<div class="noti-content">
							<ul class="notification-list">
								<li class="notification-message">
									<a href="#">
										<div class="media"> <span class="avatar avatar-sm">
											<img class="avatar-img rounded-circle" alt="User Image" src="assets1/img/profiles/avatar-02.jpg">
											</span>
								...
								<li class="notification-message">
									<a href="#">
										<div class="media"> <span class="avatar avatar-sm">
											<img class="avatar-img rounded-circle" alt="User Image" src="assets1/img/profiles/avatar-11.jpg">
											</span>
											<div class="media-body">
								...
								<li class="notification-message">
									<a href="#">
										<div class="media"> <span class="avatar avatar-sm">
											<img class="avatar-img rounded-circle" alt="User Image" src="assets1/img/profiles/avatar-17.jpg">
											</span>
											<div class="media-body">
								...
								<li class="notification-message">
									<a href="#">
										<div class="media"> <span class="avatar avatar-sm">
											<img class="avatar-img rounded-circle" alt="User Image" src="assets1/img/profiles/avatar-13.jpg">
											</span>
											<div class="media-body">
				...
				<li class="nav-item dropdown has-arrow">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img class="rounded-circle" src="assets1/img/profiles/avatar-01.jpg" width="31" alt="Soeng Souy"></span> </a>
					<div class="dropdown-menu">
						<div class="user-header">
							<div class="avatar avatar-sm"> <img src="assets1/img/profiles/avatar-01.jpg" alt="User Image" class="avatar-img rounded-circle"> </div>
							<div class="user-text">
								<h6>Soeng Souy</h6>
    ...
    <div class="row formtype">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input id="first-name" name="first_name" class="form-control" type="text" value="">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label for="last-name">Last Name</label>
                <input id="last-name" name="last_name" class="form-control" type="text" value="">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label for="phone-number">Phone Number</label>
                <input id="phone-number" name="phone_number" class="form-control" type="text" value="">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input id="employee-id" name="employee_id" class="form-control" type="text" value="">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="cal-icon">
                    <input id="birth-date" name="birth_date" type="text" class="form-control datetimepicker">
                </div>
            </div>
        </div>
    </div>
