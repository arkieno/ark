...
<head>
    ...
    height: 100%; /* Make each card wrapper take the full height of its container */
}

.teacher-image {
    width: 100%; /* Ensure images take full width of their container */
    height: 400px; /* Set a fixed height for all teacher images */
    object-fit: cover; /* Maintain aspect ratio and cover container */
}

.card-body {
    flex-grow: 3; /* Make card-body occupy remaining space in the card wrapper */
}
                        ...
                        <div class="card-wrapper">
                            <div class="card mb-5"> 
                                ...
                                <div class="card-body teacher-content p-25">  
                                    <h4 class="card-title mb-1"><a href="teacher-details.html"><?= $teacher['name'] ?></a></h4>
                                    <span class="primary-color d-block mb-4"><?= $teacher['designation'] ?></span>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            rows.forEach(function(row) {
                ...
                // Find the tallest card height in the row
                var maxHeight = 0;
                ...
                // Set the height of all cards in the row to the tallest card height
                cards.forEach(function(card) {
